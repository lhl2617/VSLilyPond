    ...
    suite(`MMSSToms suite`, () => {
        const MMSSTomsTestsException: {
        ...
        }[] = [
            {
                name: "Empty string",
                mmss: ``,
                error: new Error(` does not match the required syntax: \/\^[0-9]+:[0-5][0-9]\$\/. Valid examples: 1:23, 10:59, 0:12`),
            },
            {
                name: "Number only",
                mmss: `12`,
                error: new Error(`12 does not match the required syntax: \/\^[0-9]+:[0-5][0-9]\$\/. Valid examples: 1:23, 10:59, 0:12`),
            },
            {
                name: "Number only 2",
                mmss: `11232`,
                error: new Error(`11232 does not match the required syntax: \/\^[0-9]+:[0-5][0-9]\$\/. Valid examples: 1:23, 10:59, 0:12`),
            },
            {
                name: "0:0",
                mmss: `0:0`,
                error: new Error(`0:0 does not match the required syntax: \/\^[0-9]+:[0-5][0-9]\$\/. Valid examples: 1:23, 10:59, 0:12`),
            },
            {
                name: "0:60",
                mmss: `0:60`,
                error: new Error(`0:60 does not match the required syntax: \/\^[0-9]+:[0-5][0-9]\$\/. Valid examples: 1:23, 10:59, 0:12`),
            },
            {
                name: "0:012",
                mmss: `0:012`,
                error: new Error(`0:012 does not match the required syntax: \/\^[0-9]+:[0-5][0-9]\$\/. Valid examples: 1:23, 10:59, 0:12`),
            },
        ];
